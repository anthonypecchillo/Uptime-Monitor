...
workers.performCheck = function(originalCheckData) {
  ...
  var requestDetails = {
    ...
    'path': path,
    'timeout': originalCheckData.timeoutSeconds * 1000,    // Must convert to milliseconds (user provides in seconds)
  };
...
// Process the check outcome, update the check data as needed, trigger an alert if necessary
...
workers.init = function() {
  ...
  workers.gatherAllChecks();
  // Call the loop so that checks will continue to execute on their own
  workers.loop();
};
